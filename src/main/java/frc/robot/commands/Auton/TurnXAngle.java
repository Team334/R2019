...
import frc.robot.pid.HeadingPIDSource;
import frc.robot.pid.StandardPIDOutput;
...
public class TurnXAngle extends Command {
    ...
    public TurnXAngle(double angle) {
        ...
        this.angle = angle;
        pidController = new PIDController(0.052, 0, 0.0515, new HeadingPIDSource(), new StandardPIDOutput());
    }
