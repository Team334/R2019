...
public class Constants {
    ...
    public static final double WINDOW_MOTOR_SPEED_OPEN = 0.9;
    public static final double WINDOW_MOTOR_SPEED_CLOSE = 0.7;
    ...
    public static final double INTAKE_PID_P = 0.005;
    ...
    public static final double AUTON_DRIVE_MULTIPLIER = 0.3;
 
    public static final double MOVE_X_FEET_GYRO_P = 0.001;
    public static final double MOVE_X_FEET_GYRO_I = 0;
    public static final double MOVE_X_FEET_GYRO_D = 0;

    public static final double MOVE_X_FEET_ENC_P = 0.002;
    public static final double MOVE_X_FEET_ENC_I = 0;
    public static final double MOVE_X_FEET_ENC_D = 0.007;

    public static final double CURVE_P = 0.02;
    public static final double CURVE_I = 0;
    public static final double CURVE_D = 0;

    public static final double TURN_X_ANGLE_P = 0.003;
